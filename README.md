...
* User-generated text may contain inaccurate, biased, or harmful language that can be reflected in generated summaries. An extensive error analysis was included in the final raport of the models.
  
* The current implementation has limitations pertaining to authentication, authorisation, logging, monitoring, or a human approval interface.
